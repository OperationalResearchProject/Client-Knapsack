...
def processHC(channel, kp):
	...
	for i in range(0, 10000):
		response = stubHillClimber.SendFitness(messages_pb2.GenericFitnessRequest(
				id=response.id,
	...
	print("HillClimber process is ended, the best solution found for this transaction is " + str(stop.fitness))
